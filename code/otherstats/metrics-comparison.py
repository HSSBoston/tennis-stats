...
CUTOFF_DATE      = pd.Timestamp("2026-05-25")
ANALYSIS_START_DATE   = CUTOFF_DATE - pd.DateOffset(years=2)
ANALYSIS_END_DATE     = CUTOFF_DATE - pd.Timedelta(days=1)
FINAL_YEAR_START_DATE = CUTOFF_DATE - pd.DateOffset(years=1)
